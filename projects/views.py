...
# (/////old function using classes - given below /////)
    ...
    if request.method == 'POST':
        ...
        if request_form.is_valid() and schedules_form.is_valid():
            ...
            if request.user.has_perm('projects.add_project') and id and is_approved != "":
                ...
                # email_message += "<tr><td></br>Project Category</td><td>:</td><td>" + project_category +"</td></tr><tr><td></br>Project Type</td><td>:</td><td>"+project_type+"</td></tr>"
                # email_message += "<tr><td></br>Expected Start Date</td><td>:</td><td>"+expected_start_date+"</td></tr>""<tr><td></br>Expected End Date</td><td>:</td>"
...
#                 email_message += "<tr><td></br>Expected End Date</td><td>:</td><td>"+expected_end_date+"</td></tr>"
#                 email_message += "<tr><td></br>Estimated Efforts(man-days)</td><td>:</td><td>"+estimated_efforts+"</td></tr>"
#                 email_message += "<tr><td></br>Objectives</td><td>:</td><td>"+objective+"</td></tr></table>"
#                 email_message += 'Project Approval Status'
